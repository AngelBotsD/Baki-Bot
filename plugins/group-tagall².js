const handler = async (m, { conn, participants, isAdmin, isOwner }) => {
  ...
  // === MAPA DE LADAS (completo E.164 resumido) ===
  const flags = {
    '1': '🇺🇸', '7': '🇷🇺', '20': '🇪🇬', '27': '🇿🇦', '30': '🇬🇷', '31': '🇳🇱',
    '32': '🇧🇪', '33': '🇫🇷', '34': '🇪🇸', '36': '🇭🇺', '39': '🇮🇹', '40': '🇷🇴',
    '41': '🇨🇭', '43': '🇦🇹', '44': '🇬🇧', '45': '🇩🇰', '46': '🇸🇪', '47': '🇳🇴',
  ...
  for (const user of participants) {
    ...
    // 🔧 Normalizar: quitar "521" → "52"
    if (numero.startsWith('521')) numero = '52' + numero.slice(3);
    if (numero.startsWith('549')) numero = '54' + numero.slice(3);
